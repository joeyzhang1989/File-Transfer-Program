...
char localhost[11];			//local host name
char remotehost[11];		//remote host name
...
struct client_info {
	...
	char username[11];		//client username
	char direction[4];
	char localhost[11];		//transfer direction
...
int main(void)
{
	...
	try {
		...
		while(1) {
			...
			cout << "\nPlease type  remote host name(enter \"quit\" to exit): ";   
			cin >> remotehost ;
